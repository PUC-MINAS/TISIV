        ...
        <form action="{{url('projetos')}}" method="post" onsubmit="return validaForm(this);">
            ...
            <div class="form-row">
                <div class="form-group col-md-8">
                    ...
                    <input type="text" class="form-control" name="nome" onfocusout="validaInputNome(this)">
                </div>
            ...
            <div class="form-row">
                <div class="form-group col-md-6">
                    ...
                    <input id="inputDataInicio" class="form-control" type="date" name="inicio" value="{{date('Y-m-d')}}" onfocusout="validaInputDataInicio(this)">
                </div>
                <div class="form-group col-md-6">
                    <label for="fim">Fim do Projeto</label>
                    <input class="form-control" type="date" name="fim" value="{{date('Y-m-d', strtotime('+6 month'))}}" onfocusout="validaInputDataFim(this)">
                </div>
            </div>
            <div class="form-row">
                <div class="form-group col-md-6">
